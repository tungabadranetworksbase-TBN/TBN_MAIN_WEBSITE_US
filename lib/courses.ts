...
const DEMO_NOTE = "Duration and fees are shared on the free demo call, with the current syllabus and batch dates.";
const VENDOR_NOTE =
...
export const courses: Course[] = [
  {
    ...
    faqs: [
      ...
      { question: "How long does the course take?", answer: DEMO_NOTE },
    ],
...

  {
    ...
    duration: "Six months of access. Pricing is shared on the demo call.",
